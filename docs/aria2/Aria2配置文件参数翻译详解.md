...
## 二.配置文件
请注意，原翻译来自AriaNG语言文件——>[传送门](https://github.com/mayswind/AriaNg/blob/master/src/langs/zh_Hans.txt)

默认配置内容来自Aria2 1.33.0文档——>[传送门](https://aria2.github.io/manual/en/html/aria2c.html#aria2-conf)
